...
Windows Command Prompt adalah aspek yang sering diabaikan dari OS Windows modern. Prompt perintah, juga dikenal sebagai cmd.exe atau cmd adalah interpreter baris perintah yang tersedia sejak baris NT OS Windows. Sementara sebagian besar alasan yang digunakan untuk command prompt sekarang dapat dilakukan melalui antarmuka grafis, aplikasi ini tetap dengan Windows dan masih digunakan oleh banyak orang. Meskipun banyak dari kita mungkin tidak menggunakannya, fakta bahwa mereka masih ada di Windows modern adalah alasan yang cukup bagi kita untuk mengenalnya.

Sementara perintah di Windows 10, 8, 7, Vista, dan XP disebut perintah CMD atau perintah Prompt Perintah, perintah di Windows 98/95 dan MS-DOS disebut perintah DOS. Pada artikel ini, kami telah mencantumkan perintah yang paling umum digunakan dalam sistem operasi Windows. Di sumber ini Anda dapat mempelajari perintah cmd dan apa yang mereka lakukan. Jika Anda memiliki perintah cmd yang ingin Anda tambahkan, Anda dapat mendukungnya.
...
##### Mail : root@sadcode.org

##### Facebook : https://facebook.com/sadcode.org

##### GitHub : https://github.com/sadcode-org

##### Website : https://SadCode.org
